...
//        string connectionId,
//        IEnumerable<WebRtcIceServer>? iceServers = null
//    )
//    {
//        dotNetReference ??= DotNetObjectReference.Create(this);
//        await jsRuntime.InvokeVoidAsync(
//            "webrtcInterop.createConnection",
//            connectionId,
//            dotNetReference,
//            iceServers
//        );
...
//    public async ValueTask<IJSObjectReference> StartLocalStreamAsync(
//        string connectionId,
//        object? constraints = null
//    )
//    {
//        return await jsRuntime.InvokeAsync<IJSObjectReference>(
//            "webrtcInterop.startLocalStream",
//            connectionId,
//            constraints
//        );
//    }
...
//    public async ValueTask CreateDataChannelAsync(
//        string connectionId,
//        string label,
//        WebRtcDataChannelOptions? options = null
//    )
//    {
//        await jsRuntime.InvokeVoidAsync(
//            "webrtcInterop.createDataChannel",
//            connectionId,
//            label,
//            options
//        );
...
//    {
//        return await jsRuntime.InvokeAsync<WebRtcAnswer>(
//            "webrtcInterop.createAnswer",
//            connectionId
//        );
//    }

//    public async ValueTask SetRemoteDescriptionAsync(
//        string connectionId,
//        WebRtcSessionDescription description
//    )
//    {
//        await jsRuntime.InvokeVoidAsync(
//            "webrtcInterop.setRemoteDescription",
//            connectionId,
//            description
//        );
//    }
...
//    public async ValueTask AttachRemoteAudioAsync(
//        string connectionId,
//        ElementReference audioElement
//    )
//    {
//        await jsRuntime.InvokeVoidAsync(
//            "webrtcInterop.attachRemoteStream",
//            connectionId,
//            audioElement
//        );
//    }
...
//            this,
//            new WebRtcIceCandidateEventArgs(connectionId, candidate)
//        );
...
//            this,
//            new WebRtcConnectionStateChangedEventArgs(connectionId, state)
//        );
//        return Task.CompletedTask;
//    }
...
//    {
//        DataChannelStateChanged?.Invoke(
//            this,
//            new WebRtcDataChannelStateChangedEventArgs(connectionId, state)
//        );
//        return Task.CompletedTask;
//    }
...
//    {
//        DataBytesMessageReceived?.Invoke(
//            this,
//            new WebRtcDataBytesMessageEventArgs(connectionId, message)
//        );
//        return Task.CompletedTask;
//    }
